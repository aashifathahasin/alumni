...
if(isset($_POST['btn-signup']))
{
 ...
 if(mysql_query("INSERT INTO alumni(name,username,password,rollno,email,passout,mobile,occupation) VALUES('$name','$username','$password','$rollnumber','$email','$passout','$mobile','$occupation')"))
 {
  ?>
...
<form class="jotform-form"  method="post" name="form_70173843495462" id="70173843495462" accept-charset="utf-8">
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_18">
        ...
        <div id="cid_18" class="form-input jf-required">
          <input type="text" id="input_18" name="q18_name" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="" placeholder="eg Name" data-component="textbox" />
        </div>
      </li>
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_20">
        ...
        <div id="cid_20" class="form-input jf-required">
          <input type="password" id="input_20" name="q20_password" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="" placeholder="password" data-component="textbox" />
  ...
  <a class="btn btn-lg btn-primary btn-block" href="alumnilogin.php">Login</a>
