...
<!--                        <div id="my-calendars" class="panel panel-default" style="margin-top: 10px; margin-left: 3px;">
                            ...
                            <div class="list-group" id="list-group">
                                ...
                                <?php if($allCalendars != NULL) foreach($allCalendars as $k => $v){ ?>
                                    ...
                                    ?>
<!--                                    <a href="javascript:void(0);" class="list-group-item ladda-button <?php echo $activeClass?>" data-style="expand-right" style="background-color: <?php echo $v['color']?>; color:black;" id="<?php echo $v['id']?>">
                                     <span class="ladda-label"><?php echo $v['name']?></span> <?php echo $active?></a>-->
                                <?php } ?>
                            </div>
                        <!--</div>-->
                    </div>
