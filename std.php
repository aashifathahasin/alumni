...
if(isset($_POST['btn-signup']))
{
 ...
 if(mysql_query("INSERT INTO std(name,uname,pass,rollno,email,passout,department,mobile,occupation) VALUES('$name','$uname','$pass','$rollnumber','$email','$passout','$department','$mobile','$occupation')"))
 {
  ?>
