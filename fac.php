...
if(isset($_POST['btn-signup']))
{
 ...
 if(mysql_query("INSERT INTO faculty(name,uname,pass,yearsinceservingindepartment,email,designation,qualification) VALUES('$name','$uname','$pass','$yearsinceservingindepartment','$email','$designation','$qualification')"))
 {
  ?>
...
<form class="jotform-form"  method="post" name="form_70173843495462" id="70173843495462" accept-charset="utf-8">
      ...
      <li class="form-line" data-type="control_dropdown" id="id_17">
        ...
        <div id="cid_17" class="form-input jf-required">
          <select class="form-dropdown" id="input_17" name="q17_designation" style="width:150px;" data-component="dropdown">
            <option disabled selected value> -- select an option -- </option>
			 <option value="Professor and head of the Department">Professor and head of the Department </option>
  ...
  <a class="btn btn-lg btn-primary btn-block" href="facultylogin.php">Login</a>
