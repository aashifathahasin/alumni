...
<!--        <div>
                    ...
                    <form class="form-horizontal" role="form" id="loginForm">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-0 col-sm-10">
                                <button type="submit" class="btn btn-default ladda-button" data-style="expand-right" data-spinner-color="#010101" id="login">
    ...
    <div class="footer">
        <!--<p>© <a href="http://phpeventcalendar.com" target="_new">phpeventcalendar.com</a> 2014</p>-->
    </div>
