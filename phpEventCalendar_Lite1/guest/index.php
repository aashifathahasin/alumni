                    ...
                    <div class="col-md-2" style="padding: 0;max-width:225px;min-width:225px">
                        ...
                        <div id="my-calendars" class="panel panel-default" style="margin-top: 10px; margin-left: 3px;">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="width: 100%">My Calendars <span id="add-calendar" class="glyphicon glyphicon-plus" style="float: right; margin-left: 8px;"></span>&nbsp;<span id="manage-calendar" class="glyphicon glyphicon-cog" style="margin-top:1px; float: right; cursor: pointer;"></span></h3>
                            </div>
