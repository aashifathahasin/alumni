...
<ul class="w3-navbar w3-theme w3-dark-grey">
  ...
  <li><a class="w3-padding-16" href="#"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a></li>
</ul>
<h1><center>DISCUSSION FORUM</center></h1>
<div id="input">
<form action ="discussion.php" method="post">
	 <lable><b><font  color=" red">Enter Name:<input type="text" name="sender"/></font></b></lable>
	 <lable><b><font  color=" red">Enter Message:<input type="text" name="message" /></font></b></lable>
