...
if(isset($_POST['btn-signup']))
{
 ...
 if(mysql_query("INSERT INTO other(name,uname,pass,email,mobile) VALUES('$name','$uname','$pass','$email','$mobile')"))
 {
  ?>
...
<form class="jotform-form"  method="post" name="form_70173843495462" id="70173843495462" accept-charset="utf-8">
  ...
  <a class="btn btn-lg btn-primary btn-block" href="otherlogin.php">Login</a>
