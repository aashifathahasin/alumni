...
$result = mysql_query("SELECT * FROM staff WHERE username='" . $_POST["username"] . "' and password = '". $_POST["password"]."'");
...
<a class="btn btn-lg btn-primary btn-block" href="staf.php"><span class="glyphicon glyphicon-user"></span> Register</a>
