...
$result = mysql_query("SELECT * FROM faculty WHERE username='" . $_POST["username"] . "' and password = '". $_POST["password"]."'");
...
<a class="btn btn-lg btn-primary btn-block" href="fac.php"><span class="glyphicon glyphicon-user"></span> Register</a>
